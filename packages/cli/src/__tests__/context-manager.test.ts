...
describe('ContextManager', () => {
  ...
  describe('addFile', () => {
    ...
    it('throws for non-existent file', () => {
      expect(() => manager.addFile(path.join(tmpDir, 'nope.txt'))).toThrow('File not found');
    });
    ...
    it('throws when total size would exceed limit', () => {
      ...
      expect(() => manager.addFile(extra)).toThrow('Total context size would exceed');
    });
  ...
  describe('addImage', () => {
    ...
    it('throws for non-existent image', () => {
      expect(() => manager.addImage(path.join(tmpDir, 'missing.png'))).toThrow('Image not found');
    });
