...
export { DEBATE_MODES, ALL_MODES, isValidMode, getDefaultMode } from '@consilium/shared';
...
function baseMinutesForModeEstimate(config: { subAgents: boolean; rounds: number }): number {
