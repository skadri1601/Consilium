...
const softwareJsonLd = {
  ...
  applicationSubCategory: "Agent Governance / Decision Infrastructure",
  ...
  featureList: [
    "Agent governance with policy engines and quorum voting",
    "6 MCP tools for any AI client (validate, deliberate, redteam, score_risk, blind_eval, quick_consensus)",
    "Compliance-grade audit trails (EU AI Act ready)",
    "Continuous risk scoring with adversarial assessment",
    "Decision history with vector search recall",
    "Multi-vendor model routing with provider neutrality",
    "8 deliberation modes backed by peer-reviewed research",
    "Evaluation framework across regulated verticals (legal, healthcare, compliance)",
  ],
