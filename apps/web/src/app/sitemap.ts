...
const MARKETING_ROUTES: Route[] = [
  ...
  { path: "/pricing", changeFrequency: "weekly", priority: 0.9, lastModified: SITE_LAST_REVIEWED, images: DEFAULT_IMAGES },
  { path: "/about", changeFrequency: "monthly", priority: 0.7, lastModified: SITE_LAST_REVIEWED, images: [`${SITE_URL}/team/saad-kadri.jpg`, ...DEFAULT_IMAGES] },
  { path: "/faq", changeFrequency: "monthly", priority: 0.7, lastModified: "2026-04-15", images: DEFAULT_IMAGES },
  { path: "/use-cases", changeFrequency: "monthly", priority: 0.8, lastModified: "2026-04-15", images: DEFAULT_IMAGES },
  { path: "/research", changeFrequency: "monthly", priority: 0.7, lastModified: "2026-04-10", images: DEFAULT_IMAGES },
  { path: "/contact", changeFrequency: "yearly", priority: 0.5, lastModified: "2026-01-15" },
  { path: "/blog", changeFrequency: "weekly", priority: 0.8, lastModified: SITE_LAST_REVIEWED, images: DEFAULT_IMAGES },
...
const COMPARISON_ROUTES: Route[] = [
  { path: "/vs-cursor", changeFrequency: "monthly", priority: 0.8, lastModified: "2026-04-30", images: DEFAULT_IMAGES },
  { path: "/vs-aider", changeFrequency: "monthly", priority: 0.8, lastModified: "2026-04-30", images: DEFAULT_IMAGES },
  { path: "/vs-cline", changeFrequency: "monthly", priority: 0.8, lastModified: "2026-04-30", images: DEFAULT_IMAGES },
  { path: "/vs-claude-code", changeFrequency: "monthly", priority: 0.8, lastModified: "2026-04-30", images: DEFAULT_IMAGES },
  { path: "/vs-copilot", changeFrequency: "monthly", priority: 0.8, lastModified: "2026-04-30", images: DEFAULT_IMAGES },
];
