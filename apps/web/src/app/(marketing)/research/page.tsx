...
const implementationMapping = [
  ...
  },
  {
    ...
    features: [
      "Blind mode",
      "Identity-hidden judge evaluation",
      "Multiple argument orderings",
    ],
  },
  {
    finding:
      "Confidence-weighted consensus outperforms majority voting by 5-7%",
  ...
  {
    finding:
      "Adversarial debate enables scalable oversight beyond judge capability",
    paper: "Irving et al. (Alignment Forum)",
    features: [
      "Red Team mode",
      "Typed attack/defend phases",
      "Mandatory dissent",
      "Judge synthesis",
    ],
  },
  ...
  {
    finding:
      "Complexity routing reduces debate cost by 60-80% on simple questions",
  ...
  {
    finding:
      "Diverse model architectures outperform same-model ensembles by 3%",
    paper: "Chen et al. (ACL 2024)",
  ...
  },
  {
    ...
    paper: "Li et al. (AAAI 2024)",
    features: [
      "Red Team roles (attacker/defender/judge)",
      "Blind dialectical structure",
      "Persona-driven deliberation",
    ],
  },
];
  ...
  return (
    <div className="min-h-screen">
      <MarketingHero
        ...
        title={
          <>
            The <em>peer-reviewed</em> science
            <br />
            behind the council.
          </>
        }
        description={
          <>
            Every Consilium feature maps to a specific finding from published
            research at ICML, ACL, AAAI, and the AI safety community.
          </>
        }
      />
                  ...
                  <div className="flex items-start justify-between gap-4">
                    <div className="space-y-2">
                      <div className="flex items-center gap-2 flex-wrap">
                        <Badge className={paper.venueColor}>
                          {paper.venue}
                        </Badge>
                      </div>
                    ...
                    >
                      <ExternalLink
                        className="h-4 w-4 text-muted-foreground opacity-60 hover:opacity-100 transition-opacity"
                        aria-hidden
                      />
                    </Link>
                  </div>
