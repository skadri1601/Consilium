    ...
    <div className="min-h-screen">
      <section className="pt-28 pb-16 border-b border-white/[0.08]">
        <div className="container-narrow">
          <div className="eyebrow mb-5">CLI reference</div>
          <h1 className="display text-[clamp(40px,6vw,72px)] leading-[1.02] max-w-[900px]">
            Consilium from the <em>terminal.</em>
          </h1>
          <p className="mt-6 max-w-[640px] text-[17px] leading-[1.55] text-ink-secondary">
            Twelve commands, twenty+ slash commands, five output formats.
            Interactive chat, benchmarks, sessions, decision extraction.
          </p>
        </div>
      </section>
...
consilium debate"How should I architect my microservices? " --mode council`}</code>
                ...
                <Card key={cmd.name}>
                  <CardHeader className="pb-2">
                    <CardTitle className="text-base font-mono">
                      <span className="text-warm">consilium</span> {cmd.name}
                    </CardTitle>
                  </CardHeader>
                        ...
                        <table className="w-full text-sm">
                          <tbody>
                            {cmd.flags.map((f) => (
                              ...
                              >
                                <td className="px-4 py-2 font-mono text-xs text-warm whitespace-nowrap">
                                  {f.flag}
                                </td>
                ...
                <tbody>
                  {slashCommands.map((row) => (
                    <tr
                      ...
                      className="border-b border-white/[0.06] last:border-0"
                    >
                      <td className="px-6 py-3 font-mono text-xs text-warm whitespace-nowrap">
                        {row.cmd}
                      </td>
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground mb-4">
              ...
              <code className="rounded bg-bg-1 px-1.5 py-0.5 text-xs text-warm">
                --output
              </code>{" "}
              or the{" "}
              <code className="rounded bg-bg-1 px-1.5 py-0.5 text-xs text-warm">
                ...
                <tbody>
                  {outputFormats.map((row) => (
                    <tr
                      ...
                      className="border-b border-white/[0.06] last:border-0"
                    >
                      <td className="px-6 py-3 font-mono text-xs text-agree">
                        {row.format}
                      </td>
                      <td className="px-6 py-3 text-muted-foreground">
                        {row.desc}
                  ...
                  <tbody>
                    {[
                      ...
                      <tr
                        ...
                        className="border-b border-white/[0.06] last:border-0"
                      >
                        <td className="px-6 py-3 font-mono text-warm">
                          {row.flag}
                        </td>
                        <td className="px-6 py-3 text-muted-foreground">
                          {row.desc}
