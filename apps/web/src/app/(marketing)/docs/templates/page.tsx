...
function attackCategoryLabelCount(
  attackCategories: string | null | undefined,
): number {
...
const templates = [
    ...
    rubric: [
      {
        dimension: "Security",
        weight: "30%",
        desc: "Vulnerabilities, injection risks, auth flaws, data exposure",
      },
      {
        dimension: "Correctness",
        weight: "25%",
        desc: "Logic errors, off-by-one, null handling, race conditions",
      },
      {
        dimension: "Performance",
        weight: "20%",
        desc: "Time complexity, memory usage, unnecessary allocations",
      },
      {
        dimension: "Maintainability",
        weight: "15%",
        desc: "Code clarity, naming, structure, testability",
      },
      {
        dimension: "Style",
        weight: "10%",
        desc: "Consistency, formatting, idiomatic patterns",
      },
    ],
    ...
    rubric: [
      {
        dimension: "Accuracy",
        weight: "30%",
        desc: "Factual correctness of claims and interpretations",
      },
      {
        dimension: "Evidence Quality",
        weight: "25%",
        desc: "Strength and relevance of cited sources",
      },
      {
        dimension: "Completeness",
        weight: "20%",
        desc: "Coverage of relevant perspectives and findings",
      },
      {
        dimension: "Bias Awareness",
        weight: "15%",
        desc: "Recognition of limitations and potential biases",
      },
      {
        dimension: "Citation Quality",
        weight: "10%",
        desc: "Proper attribution and source reliability",
      },
    ],
    ...
    rubric: [
      {
        ...
        weight: "25%",
        desc: "Completeness of risk catalog, no blind spots",
      },
      {
        dimension: "Likelihood Assessment",
        weight: "20%",
        desc: "Accuracy of probability estimates",
      },
      {
        dimension: "Impact Analysis",
        weight: "20%",
        desc: "Severity scoring and cascading effects",
      },
      {
        dimension: "Mitigation Quality",
        weight: "20%",
        desc: "Feasibility and effectiveness of proposed controls",
      },
      {
        dimension: "Compliance",
        weight: "15%",
        desc: "Regulatory alignment and framework mapping",
      },
    ],
    attackCategories: null,
    example:
    ...
    rubric: [
      {
        dimension: "Evidence Quality",
        weight: "30%",
        desc: "Strength of clinical evidence, guideline adherence",
      },
      {
        dimension: "Diagnostic Accuracy",
        weight: "25%",
        desc: "Correctness of differential diagnosis",
      },
      {
        dimension: "Safety Considerations",
        weight: "20%",
        desc: "Red flag identification, contraindication awareness",
      },
      {
        dimension: "Completeness",
        weight: "15%",
        desc: "Coverage of differential, no missed diagnoses",
      },
      {
        dimension: "Actionability",
        weight: "10%",
        desc: "Clear next steps, testable hypotheses",
      },
    ],
    attackCategories: null,
    example:
  ...
  },
  {
    ...
    rubric: [
      {
        dimension: "Legal Accuracy",
        weight: "30%",
        desc: "Correctness of legal interpretations and citations",
      },
      {
        dimension: "Risk Identification",
        weight: "25%",
        desc: "Completeness of risk and liability analysis",
      },
      {
        dimension: "Regulatory Compliance",
        weight: "20%",
        desc: "Alignment with applicable regulations",
      },
      {
        dimension: "Practicality",
        weight: "15%",
        desc: "Feasibility of recommended changes",
      },
      {
        dimension: "Clarity",
        weight: "10%",
        desc: "Clear, actionable language for non-lawyers",
      },
    ],
    attackCategories: null,
    example:
      "Review this SaaS terms of service for GDPR compliance risks and recommend specific clause revisions",
    output:
  ...
  },
  {
    ...
    rubric: [
      {
        dimension: "Quantitative Rigor",
        weight: "30%",
        desc: "VaR, CVaR, Sharpe ratio, statistical validity",
      },
      {
        dimension: "Regulatory Alignment",
        weight: "25%",
        desc: "Basel III, SOX, Dodd-Frank, MiFID II compliance",
      },
      {
        dimension: "Risk Coverage",
        weight: "20%",
        desc: "Market, credit, operational, liquidity risk completeness",
      },
      {
        dimension: "Scenario Analysis",
        weight: "15%",
        desc: "Stress testing, tail risk, Monte Carlo quality",
      },
      {
        dimension: "Actionability",
        weight: "10%",
        desc: "Hedging strategies, portfolio adjustments, timelines",
      },
    ],
    attackCategories: null,
    example:
    ...
    <div className="min-h-screen">
      <section className="pt-28 pb-16 border-b border-white/[0.08]">
        <div className="container-narrow">
          <div className="eyebrow mb-5">Vertical templates</div>
          <h1 className="display text-[clamp(40px,6vw,72px)] leading-[1.02] max-w-[900px]">
            Six pre-built <em>rubrics.</em>
          </h1>
          <p className="mt-6 max-w-[640px] text-[17px] leading-[1.55] text-ink-secondary">
            Code Review, Research Synthesis, Risk Assessment, Healthcare, Legal,
            Finance — each with mode, rubric, and system prompts.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-5xl mx-auto space-y-12">
          {templates.map((t) => {
            ...
            return (
              <Card
                key={t.name}
                id={t.name.toLowerCase().replaceAll(/[^a-z]/g, "-")}
              >
                <CardHeader>
                        ...
                        <tbody>
                          {t.rubric.map((r) => (
                            <tr
                              ...
                              className="border-b border-white/[0.06] last:border-0"
                            >
                              <td className="px-4 py-2 font-medium text-warm">
                                {r.dimension}
                              </td>
                    ...
                    <div>
                      ...
                      <div className="flex flex-wrap gap-1.5">
                        {t.attackCategories.split(",").map((cat) => (
                          <Badge
                            key={cat}
                            className="bg-red-500/10 text-dissent border-red-500/20 text-xs"
                          >
                            {cat}
                          </Badge>
                        ))}
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <p className="text-sm text-muted-foreground">
                Templates can be loaded programmatically via the template
                registry. Each template returns a configuration object with
                mode, rubric, system prompts, max rounds, and default models.
              </p>
