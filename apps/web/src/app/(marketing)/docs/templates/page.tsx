      ...
      <section className="container mx-auto px-4 py-32 md:py-40">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-xl text-muted-foreground">
            6 pre-configured deliberation templates optimized for specific
            domains. Each template defines the mode, rubric weights, system
                        ...
                        <tbody>
                          {t.rubric.map((r) => (
                            <tr
                              ...
                              className="border-b border-white/[0.06] last:border-0"
                            >
                              <td className="px-4 py-2 font-medium text-indigo-400">
                                {r.dimension}
                              </td>
