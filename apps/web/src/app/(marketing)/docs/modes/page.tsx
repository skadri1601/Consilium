  ...
  terms: [
    {
      term: "Quick mode",
      description:
        "Single-round Consilium deliberation: one model proposes, the response is evaluated, and the answer is returned. Best for simple factual queries needing a fast sanity check.",
      url: "#quick",
    },
    {
      term: "Council mode",
      description:
        "Three-round Consilium deliberation with multiple models cross-examining each other through the full propose-challenge-rebut-evaluate-vote-synthesize pipeline. The default mode.",
      url: "#council",
    },
    {
      term: "Deep mode",
      description:
        "Five-round Consilium deliberation with sub-agents researching specific points before the next round. For high-stakes, mission-critical questions.",
      url: "#deep",
    },
    {
      term: "Blind mode",
      description:
        "Council deliberation with model identity stripped during evaluation so brand bias cannot influence votes.",
      url: "#blind",
    },
    {
      term: "Red Team mode",
      description:
        "Adversarial Consilium deliberation: one cohort of models attacks the proposal across eight categories, another defends, and a judge ruling produces the final answer.",
      url: "#redteam",
    },
    {
      term: "Jury mode",
      description:
        "Council deliberation with mandatory dissent: minority opinions are required output, modeled on common-law jury practice.",
      url: "#jury",
    },
    {
      term: "Market mode",
      description:
        "Probability aggregation using prediction-market mechanics: models stake credibility on positions, and confidences are averaged into a market price.",
      url: "#market",
    },
    {
      term: "Auto mode",
      description:
        "Complexity-based router that picks the appropriate Consilium mode for the query without the user specifying.",
      url: "#auto",
    },
    {
      term: "Condorcet method",
      description:
        "Voting method that selects the candidate who beats every other candidate in pairwise comparison. If no Condorcet winner exists, Consilium falls back to Ranked Pairs.",
      sameAs: "https://www.wikidata.org/wiki/Q839616",
    },
    {
      term: "Borda count",
      description:
        "Voting method that scores candidates by their position on each ballot. Consilium uses confidence-weighted Borda for ranking strength of agreement.",
      sameAs: "https://www.wikidata.org/wiki/Q777887",
    },
    {
      term: "Ranked Pairs",
      description:
        "Voting method that locks pairwise victories in order of margin without creating cycles. Used as the Condorcet fallback in Consilium.",
      sameAs: "https://www.wikidata.org/wiki/Q1192987",
    },
    {
      term: "Kendall tau",
      description:
        "Rank correlation coefficient. Consilium combines Kendall tau (weight 0.4) with Jaccard similarity (0.35) and concession rate (0.25) to detect convergence.",
      sameAs: "https://www.wikidata.org/wiki/Q1730681",
    },
  ],
});
...
export const metadata: Metadata = buildMetadata({
  ...
  path: "/docs/modes",
  keywords: [
    "ai deliberation modes",
    "multi-agent debate modes",
    "tree of thoughts",
    "socratic ai",
  ],
});
...
const modesComparison = [
  {
    ...
    rounds: 1,
    models: "1",
    phases: "Propose → Evaluate → Output",
    time: "~15s",
    best: "Simple factual queries",
  },
  {
    mode: "Council",
    rounds: 3,
    models: "2-5",
    phases: "Full 8-phase pipeline",
    time: "~45s",
    best: "Architecture, technical decisions",
  },
  {
    mode: "Deep",
    rounds: 5,
    models: "2-5",
    phases: "Full 8-phase + sub-agents",
    time: "~90s",
    best: "High-stakes, mission-critical",
  },
  {
    mode: "Blind",
    rounds: 3,
    models: "2-5",
    phases: "Full 8-phase (anonymous)",
    time: "~45s",
    best: "Unbiased evaluation, legal",
  },
  {
    mode: "Red Team",
    rounds: 1,
    models: "3+",
    phases: "Propose → Attack → Defend → Judge",
    time: "~120s",
    best: "Security, adversarial testing",
  },
  {
    mode: "Jury",
    rounds: 3,
    models: "3-5",
    phases: "Full 8-phase + mandatory dissent",
    time: "~60s",
    best: "Risk, healthcare, compliance",
  },
  {
    mode: "Market",
    rounds: 5,
    models: "3+",
    phases: "Propose → Bet → Update → Converge",
    time: "~90s",
    best: "Prediction, probability, finance",
  },
  {
    mode: "Auto",
    rounds: "1-5",
    ...
    time: "~45s",
    best: "When unsure which mode to use",
  },
];
      ...
      <section className="container mx-auto px-4 py-32 md:py-40">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-xl text-muted-foreground">
            Each mode implements a distinct debate protocol optimized for
            specific decision types. Choose the mode that matches your use case,
            or let Auto mode decide for you.
          </p>
        </div>
      </section>
