      ...
      <section className="pt-28 pb-16 border-b border-white/[0.08]">
        <div className="container-narrow">
          ...
          <h1 className="display text-[clamp(40px,6vw,72px)] leading-[1.02] max-w-[900px]">
            The engine <em>beneath</em>
            <br />
            the verdict.
          </h1>
          <p className="mt-6 max-w-[640px] text-[17px] leading-[1.55] text-ink-secondary">
            Phases, voting algorithms, convergence detection, dissent
            clustering, and confidence calibration — explained without
            hand-waving.
          </p>
        </div>
      </section>
                ...
                <CardContent>
                  <div className="flex flex-wrap gap-1.5 mb-4">
                    {[
                      ...
                      >
                        <span className="rounded bg-warm/12 px-2.5 py-1.5 text-xs font-mono text-warm">
                          {phase}
                        </span>
                        {i < 7 && (
                    ...
                    <table className="w-full text-sm">
                      ...
                      <tbody>
                        {stateFields.map((f) => (
                          ...
                          >
                            <td className="px-4 py-2 font-mono text-xs text-warm">
                              {f.field}
                            </td>
                ...
                <CardContent className="space-y-4">
                  <div className="space-y-3">
                    <div className="rounded-lg bg-bg-1 p-3">
                      <p className="text-sm">
                        <span className="text-warm font-medium">PROPOSAL</span>{" "}
                    ...
                    <div className="rounded-lg bg-bg-1 p-3">
                      <p className="text-sm">
                        <span className="text-warm font-medium">CHALLENGE</span>{" "}
                    ...
                    <div className="rounded-lg bg-bg-1 p-3">
                      <p className="text-sm">
                        <span className="text-warm font-medium">REBUTTAL</span>{" "}
                    ...
                    <div className="rounded-lg bg-bg-1 p-3">
                      <p className="text-sm">
                        <span className="text-warm font-medium">VOTING</span> —
                        Models cast RankedBallots: an ordered preference list of
                        proposals with a confidence_weight (0-1). Higher
                    ...
                    <div className="rounded-lg bg-bg-1 p-3">
                      <p className="text-sm">
                        <span className="text-warm font-medium">OUTPUT</span> —
