      ...
      <section id="about-content" className="container mx-auto px-4 py-20">
        <div className="max-w-3xl mx-auto text-center mb-16">
          ...
          <p className="text-lg text-muted-foreground leading-relaxed">
            ...
            that survived adversarial scrutiny — not the output of a single model
        ...
        <h2 className="text-3xl font-bold text-center mb-4">What Makes Consilium Different</h2>
      ...
      <section className="container mx-auto px-4 py-20">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-6 text-muted-foreground leading-relaxed">
            <p>
              Consilium started with a simple observation: when you ask one AI model a
              hard question, you get one perspective shaped by that model&apos;s training
              biases. Ask three models, and you get three perspectives — but no mechanism
              to resolve disagreements. We built that mechanism.
            </p>

            <p>
              The breakthrough came from academic research on multi-agent debate. Papers
              from ICML 2024 showed that structured debate between LLMs improves factual
              accuracy by 8-15%, and that truth has a natural advantage in adversarial
              argumentation. We implemented these findings as a production platform with
              formal voting theory, convergence detection, and mandatory dissent preservation.
            </p>

            <p>
              Consilium supports 15 models across 5 providers: Anthropic (Claude Opus 4.6,
              Claude Sonnet 4.5), OpenAI (GPT-4o, GPT-o1), Google (Gemini 2.0 Flash),
              xAI (Grok), and Groq for cost-effective inference. Models debate through
              a LangGraph state machine with typed challenges, categorized rebuttals,
              confidence-weighted voting, and mathematical convergence detection.
            </p>

            <p>
              The architecture is a three-tier system: Next.js 15 frontend, NestJS 11 API
              with BullMQ job processing, and a FastAPI debate engine that orchestrates
              the deliberation state machine. Every phase is recorded for full auditability —
              which models agreed, who dissented, what evidence was cited, and how consensus
              was reached.
            </p>
          </div>
        </div>
      ...
      <section className="container mx-auto px-4 py-20">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-muted-foreground mb-8 max-w-2xl mx-auto">
            Run it your way. No vendor lock-in. No hidden costs. MIT licensed with full source available.
          </p>
          ...
          <div className="flex flex-wrap justify-center gap-3">
            ...
            <Badge variant="outline" className="text-xs">Python SDK</Badge>
            <Badge variant="outline" className="text-xs">CLI</Badge>
            <Badge variant="outline" className="text-xs">REST API</Badge>
            <Badge variant="outline" className="text-xs">SSE Streaming</Badge>
