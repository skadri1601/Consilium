...
export const AGENTS = [
  ...
  },
  {
    ...
    provider: "Groq",
    description: "Smaller agentic Groq model for cheaper tool-use workflows",
    free: false,
  },
  {
    id: "grok-code-fast-1",
  ...
  },
  {
    ...
    name: "Kimi K2.6",
    provider: "Moonshot",
    description: "Moonshot's frontier 1T-parameter model with 256K context",
    free: false,
  },
  {
    id: "kimi-k2.5",
    name: "Kimi K2.5",
    provider: "Moonshot",
    description: "Previous-generation Kimi K2 for balanced cost",
    free: false,
  },
  {
    id: "kimi-k2-thinking",
    ...
    provider: "Moonshot",
    description: "Thinking-enabled Kimi K2 variant for deeper reasoning",
    free: false,
  },
  {
    ...
    provider: "Moonshot",
    description: "Faster thinking variant trading depth for latency",
    free: false,
  },
  {
    ...
    provider: "Moonshot",
    description: "Low-latency turbo preview of Kimi K2",
    free: false,
  },
  {
    ...
    provider: "OpenRouter",
    description: "Free-tier Gemma 4 26B routed via OpenRouter",
    free: true,
  },
  {
    ...
    provider: "OpenRouter",
    description: "Free-tier Gemma 4 31B routed via OpenRouter",
    free: true,
  },
  {
    ...
    provider: "OpenRouter",
    description: "Free-tier Qwen3 Coder for code-focused workloads",
    free: true,
  },
  {
    ...
    provider: "OpenRouter",
    description: "Free-tier NVIDIA Nemotron 3 Super 120B",
    free: true,
  },
  {
    ...
    provider: "OpenRouter",
    description: "Free-tier Ling 2.6 1T for deep reasoning",
    free: true,
  },
] as const;
