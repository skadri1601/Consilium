...
export const AGENTS = [
  ...
  },
  {
    ...
    provider: "Anthropic",
    description: "Anthropic's most agentic Sonnet, near-Opus at lower cost",
    free: false,
  },
  {
    id: "claude-opus-4-7",
    ...
    provider: "Anthropic",
    description: "Anthropic's previous-generation Opus flagship",
    free: false,
  },
  {
    id: "claude-opus-4-8",
    ...
    provider: "Anthropic",
    description: "Anthropic's most capable Opus for agentic work",
    free: false,
  },
  {
  ...
  },
  {
    ...
    name: "Grok 4.20",
    provider: "xAI",
    description: "xAI's four-agent reasoning model",
    free: false,
  },
  {
    id: "grok-4.3",
    name: "Grok 4.3",
    provider: "xAI",
    description: "xAI's current flagship with native video and document generation",
    free: false,
  },
  {
    id: "kimi-k2.6",
